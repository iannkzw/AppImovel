...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading"><h4 class="text-center">Lista de Imóveis</h4></div>
                    ...
                    @foreach($imoveis as $imovel)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:(confirm('Deletar registro?') ? window.location.href='{{route('imoveis.remove', $imovel->id)}}' : false)" ><i class="glyphicon glyphicon-trash"></i></a>
    ...
    <a href="{{route('imoveis.create')}}"><button class="btn btn-success">Adicionar</button></a>
@endsection